...
/// Test parsing the PDF.js repository
/// This validates that our JavaScript parser can handle a large, complex real-world codebase
#[test]
#[ignore] // This test requires the pdf.js repository to be cloned
fn test_pdfjs() {
    ...
    compare_parser_output_with_files("pdf.js", &["*.js"], exclude);
}
