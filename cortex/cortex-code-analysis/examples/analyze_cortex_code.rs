...
//!
//! This example analyzes actual code from the cortex-code-analysis crate itself.
//!
//! Run with: cargo run --example analyze_cortex_code

use cortex_code_analysis::{DependencyExtractor, DependencyType, RustParser};
...
fn main() -> anyhow::Result<()> {
    ...
    // Analyze the types.rs file from cortex-code-analysis
