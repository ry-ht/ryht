...
//!
//! This module provides a unified import point for types that cortex-coordination
...
// Re-export from cortex-storage
pub use cortex_storage::locks::{LockId, LockType};
