...
mod tests {
    ...
    async fn test_store_and_retrieve_unit() {
        ...
        let unit = CodeUnit {
            id: CortexId::new(),
            unit_type: CoreCodeUnitType::Function,
    ...
    // Test removed - deprecated SemanticUnit API replaced with CodeUnit API
    // Complex unit finding is tested via integration tests
}
