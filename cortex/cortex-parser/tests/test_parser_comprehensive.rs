//! Comprehensive tests for cortex-parser covering all edge cases and real-world scenarios.
//!
...
#[test]
fn test_ast_editor_extract_function_basic() {
    let source = r#"
fn main() {
    let x = 1;
    let y = 2;
...
"#
    ...
    let result = editor.extract_function(2, 3, "calculate_sum");
    assert!(result.is_ok());
}
