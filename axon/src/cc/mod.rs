//! # Claude Code SDK Module
//!
//! This module provides the original Claude Code SDK functionality for interacting
//! with the Claude Code CLI, providing type-safe client interfaces, session management,
//! and MCP integration.
//!
//! ## Features
//!
...
/// Session and project type definitions.
pub use session::{Project, Session, SessionMetadata};
...
pub use settings::{ClaudeSettings, HookConfig, SettingsScope};
