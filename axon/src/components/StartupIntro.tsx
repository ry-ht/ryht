...
import axonLogo from "../../src-tauri/icons/icon.png";
      ...
      {visible && (
        ...
        >
          ...
          >
            ...
            {/* axon logo slides left; brand text reveals to the right */}
...
function BrandText() {
  return (
    <div className="text-5xl font-extrabold tracking-tight brand-text">
      <span className="brand-text-solid">axon</span>
      <span aria-hidden="true" className="brand-text-shimmer">axon</span>
    </div>
  );
}
