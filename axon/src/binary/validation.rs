...
//!
//! ```no_run
//! use cc_sdk::binary::validation::{verify_binary, BinaryHealth};
//!
...
impl BinaryHealth {
    ...
    ///
    /// ```no_run
    /// use cc_sdk::binary::validation::verify_binary;
    ///
...
///
/// ```no_run
/// use cc_sdk::binary::validation::is_executable;
///
...
///
/// ```no_run
/// use cc_sdk::binary::validation::check_version_compatibility;
///
...
///
/// ```no_run
/// use cc_sdk::binary::validation::health_check_all;
///
