...
<div align="center">
  <img src="src-tauri/icons/icon.png" alt="axon Logo" width="120" height="120">
...
**axon** is a powerful desktop application that transforms how you interact with Claude Code. Built with Tauri 2, it provides a beautiful GUI for managing your Claude Code sessions, creating custom agents, tracking usage, and much more.

Think of axon as your command center for Claude Code - bridging the gap between the command-line tool and a visual experience that makes AI-assisted development more intuitive and productive.
...
1. **Launch axon**: Open the application after installation
2. **Welcome Screen**: Choose between CC Agents or Projects
3. **First Time Setup**: axon will automatically detect your `~/.claude` directory
...
Before building axon from source, ensure you have the following installed:
...
# Linux/macOS
./src-tauri/target/release/axon

# Windows
./src-tauri/target/release/axon.exe
```
...
- **Executable**: The main axon application
...
axon prioritizes your privacy and security:
