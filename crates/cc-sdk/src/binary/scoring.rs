...
//!
//! ```no_run
//! use cc_sdk::binary::{discover_installations, scoring::compare_installations};
//!
...
///
/// ```no_run
/// use cc_sdk::binary::{ClaudeInstallation, InstallationType};
/// use cc_sdk::binary::scoring::score_installation;
///
...
///
/// ```no_run
/// use cc_sdk::binary::{discover_installations, scoring::rank_installations};
///
/// let installations = discover_installations();
