...
//!
//! ```no_run
//! use cc_sdk::session::writer::{create_session, write_message};
//! use cc_sdk::core::SessionId;
//! use cc_sdk::types::Message;
//!
...
///
/// ```no_run
/// use cc_sdk::session::writer::create_session;
/// use cc_sdk::core::SessionId;
///
/// # async fn example() -> cc_sdk::Result<()> {
/// let session_id = SessionId::new("new-session");
...
///
/// ```no_run
/// use cc_sdk::session::writer::update_session_metadata;
/// use cc_sdk::core::SessionId;
///
/// # async fn example() -> cc_sdk::Result<()> {
/// let session_id = SessionId::new("session-id");
...
///
/// ```no_run
/// use cc_sdk::session::writer::create_project;
...
///
/// ```no_run
/// use cc_sdk::session::writer::delete_project;
///
/// # async fn example() -> cc_sdk::Result<()> {
